...
const Status = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 my-8  mx-auto z-10'>
            <div className='w-full   text-white  mx-auto' data-aos="zoom-in">
            <div className="flex flex-col md:flex-row  md:flex-auto justify-center  bg-gray-900 shadow-2xl py-8 my-8 rounded items-center mx-8">
            ...
            <div className='w-full  text-white  mx-auto' data-aos="zoom-in">
                <div className="flex flex-col md:flex-row  md:flex-auto justify-center bg-gray-900 py-8 my-8 rounded items-center mx-8">
