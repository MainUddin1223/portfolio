        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 mx-4 mt-8'>
                ...
                <div className='md:relative m-4'>
                    <div className='md:w-3/4 md:absolute md:bottom-0 md:left-0 shadow-lg hover:shadow-2xl  '>
                        <img src={project2} alt="" className='rounded-xl '/>
                    </div>
                </div>
                <div className='md:relative m-4'>
                    <div className='md:w-3/4 md:absolute md:top-0 md:right-0 shadow-lg hover:shadow-2xl '>
